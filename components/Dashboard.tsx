...
const Dashboard: React.FC<DashboardProps> = ({ user, onLogout, onBack }) => {
    ...
    return (
        <div className="min-h-screen w-full bg-slate-50 text-slate-800 flex items-center justify-center p-6 font-sans relative">
            ...
            <button 
                onClick={onBack}
                className="absolute top-6 right-6 z-50 p-2.5 rounded-full bg-white border border-slate-200 hover:bg-slate-100 text-slate-400 hover:text-slate-800 transition-all shadow-sm"
                title="Retour"
            >
