...
import { ArrowRightIcon, UserIcon, LogOutIcon, ViverisLogo, ChevronDownIcon, MenuIcon, XIcon, CheckIcon, SendIcon, SearchIcon } from './ui/Icons';
...
// Données extraites et adaptées du site source
const projectsData = [
    {
        id: 1,
        category: "Notre Vision / ITS",
        title: "Les ITS : Systèmes de Transports Intelligents",
        desc: "Introduction aux fondamentaux des systèmes qui révolutionnent la mobilité urbaine.",
        image: "https://images.unsplash.com/photo-1579007936257-6da452400886?q=80&w=2070&auto=format&fit=crop",
        tags: ["Systèmes Embarqués", "Automobile", "Transport"]
    },
    {
        id: 2,
        category: "Systèmes de Transport Intelligents",
        title: "Transport - Projets C-ITS",
        desc: "Sécuriser les usagers de la route grâce au projet C-ITS (Systèmes de transport intelligents coopératifs).",
        image: "https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?q=80&w=2070&auto=format&fit=crop",
        tags: ["Systèmes Embarqués", "Transport", "IoT"]
    },
    {
        id: 3,
        category: "Système connecté / électronique",
        title: "Rear Lock",
        desc: "Boîtier de sécurité connecté embarqué sur vélo en libre-service pour la sécurisation des flottes.",
        image: "https://images.unsplash.com/photo-1507035895480-2b3156c31fc8?q=80&w=2070&auto=format&fit=crop",
        tags: ["IoT", "Mobilité", "Electronique"]
    },
    {
        id: 4,
        category: "Notre vision / Télétravail",
        title: "Agilité et Télétravail",
        desc: "Et si nous en profitions pour développer l'Agilité de nos équipes ? Retour d'expérience.",
        image: "https://images.unsplash.com/photo-1593642632823-8f78536788c6?q=80&w=2070&auto=format&fit=crop",
        tags: ["Agilité", "Conseil", "Management"]
    },
    {
        id: 5,
        category: "VoD / Open Source",
        title: "Marlink",
        desc: "Le multimédia disponible pour les équipages en mer grâce à l’Open Source et aux réseaux satellites.",
        image: "https://images.unsplash.com/photo-1478860409698-8707f313ee8b?q=80&w=2070&auto=format&fit=crop",
        tags: ["Open Source", "Télécom", "Réseaux"]
    },
    {
        id: 6,
        category: "Systèmes Embarqués / Sûreté",
        title: "Ferroviaire - Projet SQV",
        desc: "Assurer la sécurité des usagers du métro automatique de Lyon. Validation et certification.",
        image: "https://images.unsplash.com/photo-1556609894-0d324df3cd3f?q=80&w=2070&auto=format&fit=crop",
        tags: ["Ferroviaire", "Sûreté de fonctionnement", "Critique"]
    },
    {
        id: 7,
        category: "Test et Simulation",
        title: "Automobile - Solution Test GMSL",
        desc: "Simuler et tester les liens Gigabit Multimedia Serial Link (GMSL) pour les véhicules autonomes.",
        image: "https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?q=80&w=2070&auto=format&fit=crop",
        tags: ["Test & Simulation", "Automobile", "Vision"]
    },
    {
        id: 8,
        category: "Notre vision / Industrie 4.0",
        title: "Informatique Industrielle vs IT",
        desc: "L’informatique industrielle et l’informatique d’entreprise peuvent-elles continuer à s’ignorer ?",
        image: "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?q=80&w=2070&auto=format&fit=crop",
        tags: ["Industrie", "IT", "Convergence"]
    },
    {
        id: 9,
        category: "Santé Connectée / IoT",
        title: "R&T - E Santé PhysioDom",
        desc: "Favoriser le maintien à domicile de personnes dépendantes par l’usage d’objets connectés.",
        image: "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?q=80&w=2070&auto=format&fit=crop",
        tags: ["Santé", "IoT", "R&D"]
    }
];

const filterCategories = ["Tous", "Systèmes Embarqués", "IoT", "Agilité", "Open Source", "Transport", "Automobile", "Santé", "Industrie"];

const ProjetsPage: React.FC<ProjetsPageProps> = ({ onNavigate, user, onLogout }) => {
                ...
                >
                    <a 
                        ...
                        className={`
                            ...
                            ${activeMenu === item.label || (item.href === '#projets') ? 'text-viveris-red bg-red-50' : 'text-slate-600 hover:text-viveris-red hover:bg-white/50'}
                        `}
                    >
                        {item.label}
                        {item.children && (
      ...
      <div className="pt-32 pb-12 bg-white relative overflow-hidden">
          ...
          <div className="max-w-[1200px] mx-auto px-6 relative z-10 text-center">
              ...
              <h1 className="text-5xl md:text-6xl font-bold text-slate-900 mb-8 animate-slide-up leading-tight">
                  Nos <span className="text-transparent bg-clip-text bg-gradient-to-r from-viveris-red to-orange-600">Projets</span>
              </h1>
              <p className="text-xl text-slate-500 max-w-3xl mx-auto leading-relaxed animate-slide-up" style={{animationDelay: '100ms'}}>
                  Découvrez comment nous accompagnons nos clients dans leurs défis technologiques, de la conception à la réalisation.
              </p>
          </div>
      </div>
      ...
      <div className="max-w-[1400px] mx-auto px-6 pb-24">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredProjects.map((project, index) => (
                  <div 
                    key={project.id} 
                    className="group bg-white rounded-[2.5rem] overflow-hidden shadow-apple hover:shadow-apple-hover transition-all duration-500 hover:-translate-y-2 flex flex-col h-full border border-slate-100 animate-slide-up"
                  ...
                  >
                      <div className="relative h-64 overflow-hidden">
                          ...
                          <div className="absolute top-6 left-6">
                              <span className="px-3 py-1.5 bg-white/20 backdrop-blur-md border border-white/30 text-white text-xs font-bold uppercase tracking-wide rounded-lg">
                                  {project.category}
                              </span>
                          </div>
                      </div>
                      ...
                      <div className="p-8 flex flex-col flex-grow">
                          <h3 className="text-2xl font-bold text-slate-900 mb-4 leading-tight group-hover:text-viveris-red transition-colors">
                              {project.title}
                          </h3>
                          ...
                          <div className="flex flex-wrap gap-2 mb-6">
                              {project.tags.map(tag => (
                                  <span key={tag} className="text-[11px] font-semibold px-2.5 py-1 bg-slate-100 text-slate-500 rounded-md">
                                      #{tag}
                                  </span>
                              ))}
                          </div>

                          <button className="w-full py-3.5 rounded-xl border border-slate-200 text-slate-700 font-bold hover:bg-slate-900 hover:text-white hover:border-slate-900 transition-all duration-300 flex items-center justify-center gap-2 group/btn">
                              Notre Réponse
          ...
          {filteredProjects.length === 0 && (
              <div className="text-center py-20">
                  <p className="text-slate-400 text-xl font-medium">Aucun projet ne correspond à ce filtre.</p>
                  <button onClick={() => setActiveFilter("Tous")} className="mt-4 text-viveris-red font-bold hover:underline">Voir tous les projets</button>
              </div>
          )}
      </div>
